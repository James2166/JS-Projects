...
function tellMe (joke) {
    VoiceRSS.speech({
        key: '46460cb1fd904967b8b3ab5a94783183',
        src: joke,
        hl: 'en-ie',
        v: 'Oran',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Pun,Christmas?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try {
